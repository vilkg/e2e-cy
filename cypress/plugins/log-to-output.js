// Just an extension of existing plugin that doesn't properly expose the commands
// https://github.com/flotwig/cypress-log-to-output/blob/master/cypress/plugins/index.js
// 
...
function install(on, filter, options = {}) {
  ...
  on('task', {
    'log-to-output:getLogs': getLogs,
    'log-to-output:clearLogs': clearLogs
  })
}
